...
export type Project = { title: string; category: string; description: string; tags: string[]; };
...
export const projects: Project[] = [
  ...
  { title: "Ecommerce Mobile App", category: "Commerce", description: "Commerce app with product catalog, cart, checkout, and supplier management workflows.", tags: ["Checkout", "Payments", "Flutter"] },
  { title: "School Management ERP", category: "ERP Product", description: "School ERP with attendance, exams, dashboards, QR check-ins, and fee payment workflows.", tags: ["ERP", "QR Attendance", "Dashboards"] },
  { title: "IoT Forest Fire Detection System", category: "IoT Solution", description: "IoT wildfire detection system using sensors, computer vision, and real-time early alerts.", tags: ["IoT", "Computer Vision", "Alerts"] },
  { title: "Personal Website", category: "Showcase Site", description: "Responsive personal brand site focused on polished UI, storytelling, and clear project presentation.", tags: ["Next.js", "UI Design", "Responsive"] },
];
