...
export function ExperienceCards() {
  return (
    <div className="experience-timeline-premium">
      {experiences.map((experience) => (
        <div key={experience.company} className="timeline-item-premium" data-animate>
          ...
          <article className="experience-card-premium h-full">
            <div className={`card-accent-strip bg-gradient-to-r ${experience.accent}`} />
